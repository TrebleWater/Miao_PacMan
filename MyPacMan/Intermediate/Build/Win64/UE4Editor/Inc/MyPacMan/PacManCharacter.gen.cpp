...
// Cross Module References
	MYPACMAN_API UClass* Z_Construct_UClass_APacManCharacter_NoRegister();
	MYPACMAN_API UClass* Z_Construct_UClass_APacManCharacter();
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	UPackage* Z_Construct_UPackage__Script_MyPacMan();
	MYPACMAN_API UFunction* Z_Construct_UFunction_APacManCharacter_OnCollision();
...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_APacManCharacter_OnCollision()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_OtherBodyIndex = { UE4CodeGen_Private::EPropertyClass::Int, "OtherBodyIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(PacManCharacter_eventOnCollision_Parms, OtherBodyIndex), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_APacManCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_APacManCharacter_OnCollision, "OnCollision" }, // 969199953
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APacManCharacter, 150439226);
	static FCompiledInDefer Z_CompiledInDefer_UClass_APacManCharacter(Z_Construct_UClass_APacManCharacter, &APacManCharacter::StaticClass, TEXT("/Script/MyPacMan"), TEXT("APacManCharacter"), false, nullptr, nullptr, nullptr);
